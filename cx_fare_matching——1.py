...
if __name__ == '__main__':
    ...
    # start = datetime.now()
    # curs = myConnection.cursor()
    # stmt = "call rax.cx_fm_pre_cmz(1, 1,'cx','201711')"
    # curs.execute(stmt)
    # curs.close()
    # end = datetime.now()
    ...
    # start = datetime.now()
    # curs = myConnection.cursor()
    # stmt = "call rax.cx_fm_pre_static(1, 1,'cx','201711')"
    # curs.execute(stmt)
    # curs.close()
    # end = datetime.now()
    # msg = "Pre_fare_static matching cost %s seconds" % (end - start).total_seconds()
    ...
    # start = datetime.now()
    # curs = myConnection.cursor()
    # stmt = "call rax.cx_fm_pre_dynm(1, 1, 'cx','201711')"
    # curs.execute(stmt)
    # curs.close()
    # end = datetime.now()
    ...
    FileWrite(msg)
    curs = myConnection.cursor()
    # stmt = "call rax.cx_fm_post3_dump2audit(1, 1, '2018-05-01', '2018-5-31','201711')"
    stmt = "call rax.cx_fm_post3_dump2audit_pu_io('201711')"
    curs.execute(stmt)
    curs.close()
    end = datetime.now()
    msg = "End Time %s"%end
